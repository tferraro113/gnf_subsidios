...
<div id="container" class="container">
	<div class="container">
		<h2><?php echo $lang->line('setting_email_reset_password');?></h2>
		...
		<div class="row-fluid show-grid">
			<form accept-charset="utf-8" method="post" id="SettingSaveForm"
				...
				<div class="control-group">
					<label class="control-label" for="email-activate-resend-subj"><?php echo $lang->line('request'); ?>
					</label>
					<div class="controls">
						<label> <input type="text" id="SettingRequestSubject"
							<?php if (isset($this->data['request_subject'])){?>
								value = "<?php echo htmlspecialchars($this->data['request_subject']); ?>"
								<?php }?>
								placeholder="Subject"
						...
						<textarea id="SettingRequestBody" placeholder="Message body"
							rows="10" class="input-xlarge" name="data[request_body]"><?php if (isset($this->data['request_body'])){
									echo htmlspecialchars($this->data['request_body']);  }?></textarea>
				...
				<div class="control-group">
					...
					<div class="controls">
						<label> <input type="text" id="SettingSuccessSubject"
							<?php if (isset($this->data['success_subject'])){?>
								value = "<?php echo htmlspecialchars($this->data['success_subject']); ?>"
								<?php }?>
						...
						<textarea id="SettingSuccessBody" placeholder="Message body"
							rows="10" class="input-xlarge" name="data[success_body]"><?php if (isset($this->data['success_body'])){
									echo htmlspecialchars($this->data['success_body']);  }?></textarea>
						<div class="help-inline">
							<p><?php echo $lang->line('message_body');?></p>
							<br>
							<p>
