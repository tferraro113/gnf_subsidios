...
<div class="container">
	<h2><?php echo $lang->line('tool_group_component'); ?></h2>
	<ul class="nav nav-tabs" id="auth_tab" style="margin-bottom: 0px;">
		...
		<li class="active"><a href="<?php echo strUrl('admin/component/groups.php'); ?>"><?php echo $lang->line('group_component'); ?></a></li>
