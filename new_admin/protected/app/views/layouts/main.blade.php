...
<body >
<div style="display:none;" class="navbar navbar-default "  id="top-bar">
...
<nav class="navbar navbar-inverse " role="navigation">
  <div class="container-fluid">
    <div class="navbar-header">
     ...
     <a class="navbar-brand" href="{{ URL::to('config/dashboard')}}"><img src="{{  URL::to('/uploads/images/logofenosa.jpg'); }}" alt=""> {{ CNF_APPNAME }}</a>
