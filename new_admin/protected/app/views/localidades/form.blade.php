  ...
  <div class="page-content">
    ...
    <div class="breadcrumb-line">
      <ul class="breadcrumb">
		...
		<li><a href="{{ URL::to('localidades') }}">{{ $pageTitle }}</a></li>
	...
	<div class="panel-default panel">
		...
		<ul class="parsley-error-list">
		 ...
		 {{ Form::open(array('url'=>'localidades/save/'.SiteHelpers::encryptID($row['id']), 'class'=>'form-horizontal','files' => true , 'parsley-validate'=>'','novalidate'=>' ')) }}
				<div class="col-md-12">
			...
			<div style="clear:both"></div>	
			  ...
			  <div class="form-group">
				...
				<button type="button" onclick="location.href='{{ URL::to('localidades') }}' " id="submit" class="btn btn-success ">  {{ Lang::get('core.sb_cancel') }} </button>
				</div>	  
   ...
   <script type="text/javascript">
	$(document).ready(function() { 
		...
		$("#municipio_id").jCombo("{{ URL::to('localidades/comboselect?filter=municipios:id:nombre') }}",
