...
<script>
            ...
            function crudExport() {
                $('#crudIframe').attr({src: '<?php echo strUrl('admin/scrud/exportCsv.php?table='.$_GET['table'].'&xtype=exportcsv'); ?>'});
            }
            function crudExportAll() {
                $('#crudIframe').attr({src: '<?php echo strUrl('admin/scrud/exportCsv.php?table='.$_GET['table'].'&xtype=exportcsvall'); ?>'});
            }
</script>