...
$pdo = $pdo_obj->prepare('INSERT INTO contactos ( nombre, apellido, sexo, fecha_nacimiento, tipo_documento, numero, telefono , mail, municipio_id, localidad_id, calle, numero_calle, complemento, entre_calles, instalacion_coccion, instalacion_aguaCaliente, instalacion_calefaccion, created ,posee_gas ,created_by, consulta) VALUES ( :nombre , :apellido, :sexo, :fecha_nacimiento , :tipo_documento, :numero, :telefono, :mail, :municipio_id , :localidad_id , :calle, :numero_calle , :complemento , :entre_calles , :instalacion_coccion , :instalacion_aguaCaliente, :instalacion_calefaccion , :created , :posee_gas,:created_by ,:consulta)');
