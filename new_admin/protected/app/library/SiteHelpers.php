							...
							{			
								$f .= '					
								  <div class="form-group '.$hidethis.' '.$inhide.'" '.$show .'>
									<label for="'.$form['label'].'" class=" control-label col-md-4 text-left"> '.$form['label'].' </label>
									<div class="col-md-8">
								...
								$f .= '					
								  <div class="form-group '.$hidethis.' '.$inhide.'" '.$show .'>
									<label for="ipt" class=" control-label "> '.$form['label'].' </label>									
									  '.self::formShow($form['type'],$form['field'],$form['required'],$form['option']).' '.$tooltip.'						
								  </div> '; 							
		...
		switch($type)
		{
			...
			case 'select';
				...
				if($option['opt_type'] =='datalist')
				{
					...
					$form = "
					<select name='{$field}' rows='5' id='{$field}'  {$mandatory}  
