...
<form class="form-horizontal">
	<div id="dataListConfigCommon" style="margin-top: 10px;">
	    <div class="control-group">
	        <label class="control-label" for="crudTitle"><b><?php echo $lang->line('title');?></b> </label>
	        <div class="controls">
	            <input type="text" id="crudTitle" name="crud[title]">
	        </div>
	    </div>
	    <div class="control-group">
	        <label class="control-label" for="crudRowsPerPage"><b><?php echo $lang->line('rows_per_page');?></b>
	        </label>
	        <div class="controls">
	    ...
	    <div class="control-group">
	        <label class="control-label" for="crudOrderField"><b><?php echo $lang->line('order_by');?></b> </label>
	        <div class="controls">
	            ...
	            <select style="width: auto;" name="crud[order_type]" id="crudOrderType">
	                <option value=""></option>
	                <option value="asc"><?php echo $lang->line('asc');?></option>
	                <option value="desc"><?php echo $lang->line('desc');?></option>
	            </select>
	        </div>
	    </div>
            <div class="control-group">
                    <label class="control-label" for="crudNoColumn"><b><?php echo $lang->line('no_column');?></b></label>
                    <div class="controls">
                        <input type="checkbox" value="1" id="crudNoColumn">
                    </div>
                </div>
	    <div class="control-group">
	        <label class="control-label"><b><?php echo $lang->line('join');?></b> </label>
	        <div class="controls">
	        	<div id="dataListJoin" style="margin-bottom: 5px;"></div>
	            <input type="button" class="btn" value="<?php echo $lang->line('add_join'); ?>" id="addJoinButton"/>
	        </div>
	    </div>
	    ...
	    <div class="control-group">
	        ...
	        <div class="controls">
	        	<div id="dataListWhere" style="margin-bottom: 5px;"></div>
	            <input type="button" class="btn" value="Add where" id="addWhereButton"/>
	        </div>
	    </div>
	</div>
    ...
    <div>
        <ul id="dataListConfigElement" class="nav nav-tabs">
            <li class="active"><a href="#filter" data-toggle="tab">
            	<?php echo $lang->line('filter_elements');?>
            </a></li>
            <li><a href="#column" data-toggle="tab"><?php echo $lang->line('column_elements');?></a></li>
        </ul>
