<?php
   ...
   ?>
<!DOCTYPE html>
<!-- saved from url=(0034)http://www.gnfshop.com.ar/contacto -->
<html class=" js flexbox canvas canvastext webgl no-touch geolocation postmessage websqldatabase indexeddb hashchange history draganddrop websockets rgba hsla multiplebgs backgroundsize borderimage borderradius boxshadow textshadow opacity cssanimations csscolumns cssgradients cssreflections csstransforms csstransforms3d csstransitions fontface generatedcontent video audio localstorage sessionstorage webworkers applicationcache svg inlinesvg smil svgclippaths" lang="es">
   ...
   <head>
      ...
      <link rel="stylesheet" type="text/css" href="files/styles(1).css" media="all">
      <link rel="stylesheet" type="text/css" href="files/print.css" media="print">
      <script type="text/javascript" async="" src="files/ga.js"></script><script async="" src="files/gtm.js"></script><script type="text/javascript" src="files/prototype.js"></script>
      ...
      <![endif]-->
      <!-- Facebook Conversion Code for Tortuguitas - Leads --> 
      <script>(function() { 
         ...
         window._fbq.push(['track', '6016519044030', {'value':'0.00','currency':'ARS'}]); 
      </script> 
      <noscript><img height="1" width="1" alt="" style="display:none" src="https://www.facebook.com/tr?ev=6016519044030&amp;cd[value]=0&amp;cd[currency]=ARS&amp;noscript=1" /></noscript>
      <script type="text/javascript">
         //<![CDATA[
         Mage.Cookies.path     = '/';
   ...
   <body class=" cms-page-view cms-contacto">
	...
	<div id="header">
		<div class="row">
         ...
         <div class="row main-container col1-layout">
            <div class="col-12">
               <div class="col-main">
                  <div class="std">
                     <!--– CONTACT FORM –-->
                     ...
                     <?php
                        $STH = $pdo_obj -> prepare( "select * from banners WHERE activo = 2 AND posicion_banner = 2" );
                        ...
                        ?>
                     <img style="padding-left: 20px; padding-top: 10px;margin-bottom:20px;" width="1170" height="80" src="adm/public/media/files/<?= $banner_file ?>" alt="Banner Superior">            
                     <?
                        }elseif($banner['tipo'] == 2  )  {
                            $banner_file = 'adm/public/media/files/'.$banner['codigo'];
                            //$banner_file = 'red_triangle.swf';
                            ?>
                     <object id="FlashID" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="1170" height="80">
                        ...
                        <!--[if !IE]>-->
                        <object type="application/x-shockwave-flash" data="<?= $banner_file ?>" width="1170" height="80">
                           <!--<![endif]-->
                           <param name="quality" value="high" />
                           <param name="wmode" value="opaque" />
                           <param name="swfversion" value="6.0.65.0" />
							...
							<form action="procesador.php" id="contactForm" method="post">
								<div class="fieldset">
								   <div class="category-title">
									  <h2 class="legend">Los datos han sido ingresados exitosamente</h2>
									  Muchas gracias por tu contacto. A la brevedad un asesor comercial se comunicará con vos.<br/>
									  Ingresá a <a href="http://www.gnfshop.com.ar">www.gnfshop.com.ar</a> para encontrar una línea completa de artefactos a gas con instalación segura incluida para equipar tu hogar.<br/><br/> ¡Te brindamos nuestro mejor servicio para que puedas comprar con seguridad, rapidez y confianza!
								   </div>
							 </form> 
						</div>
					</div>
      ...
      <div id="footer">
         <div class="row content-footer" style="display:none;">
            <div class="col-12">
                  ...
                  <div class="span3">
                     ...
                     <div class="footer-col-content">
                        <ul>
                           ...
                           <li><a href="http://www.gnfshop.com.ar/centros-de-atencion">Centros de Atención</a></li>
                        </ul>
                     </div>
                  </div>
                  <div class="span3">
                     ...
                     <div class="footer-col-content">
                        <ul>
                           <li><a href="http://www.gnfshop.com.ar/terminos-y-condiciones">Términos y condiciones</a></li>
                           <li><a href="http://www.gnfshop.com.ar/preguntas-frecuentes">Preguntas frecuentes</a></li>
                           <li><a href="http://www.gnfshop.com.ar/terminos-y-condiciones-promociones-vigentes">Promoción vigente</a></li>
                        </ul>
                     </div>
                  </div>
         ...
         <address>
            <div class="container">
               ...
               <!--<span id="designed_by">
                  <a href="http://www.25watts.com.ar" title="25Watts · Diseño y Desarrollo web" target="_blank"></a>
                  <span class="pull-right">Diseño y desarrollo</span>
                  </span>-->
            </div>
         </address>
      </div>
