...
CityUpdater.prototype = {
    initialize: function (RegionEl, cityTextEl, citySelectEl, cities, disableAction, zipEl)
    {
    ...
    update: function()
    {
        if (this.cities[this.RegionEl.value]) {
            ...
            /*if (this.disableAction=='hide') {
                ...
                //periksa line dibawah ini mungkin salah
                this.lastRegionId = '';
            }
        ...
        // Make Zip and its label required/optional
        //2 line dibawah ini coba tidak usah
        //var zipUpdater = new ZipUpdater(this.regionEl.value, this.zipEl);
        //zipUpdater.update();
    },
