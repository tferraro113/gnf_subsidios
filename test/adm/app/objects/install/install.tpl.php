...
<form method="post">
    <div style="padding:2px 8px 7px 8px; 
         ...
         border-radius: 7px;">
        <center><h3>PHP Admin Pro V1.1 INSTALLATION</h3></center>
        <p>Welcome to PHP Admin Pro V1.1.</p>
        <h4>Config folder</h4>
        ...
        <?php } ?>
        <input type="submit" class="btn btn-large btn-success" value="Installation v1.1" />
